...
const METRICS = [
  { v: '4 wks', l: 'Fastest governance program', s: 'Audit-ready output' },
        ...
        <div style={{ display: 'grid', gridTemplateColumns: stacked ? '1fr' : '320px 1fr', minHeight: stacked ? undefined : 480 }}>
          ...
          <div style={{ padding: stacked ? '32px 0 44px' : '72px 60px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <Link href="#" className="hv" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, border: '1.5px solid rgba(255,255,255,0.25)', color: '#fff', borderRadius: 24, padding: '14px 22px', textDecoration: 'none', fontFamily: MN, fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', transition: 'background .2s,color .2s,border-color .2s,transform .15s' }}
    ...
    return (
        <section style={{ padding: `${pv}px ${gv}px`, background: BG, borderRadius: '24px 24px 0 0', marginTop: -24 }}>
            ...
            <div style={{ display: 'grid', gap: 1, background: PL, borderRadius: 16, overflow: 'hidden', border: `1px solid ${PL}`, marginTop: 36 }}>
                {FRAMEWORKS.map(f => (
                    <div key={f.name} style={{ background: BG, padding: '22px 20px', display: 'grid', gridTemplateColumns: layout === 'mobile' ? '1fr' : '1fr 1fr 1fr', gap: 12 }}>
