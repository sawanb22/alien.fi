...
const METRICS = [
  ...
  { v: "6 wks", l: "Avg to first model", s: "Discovery to working prototype" },
...
export default function ServiceCustomAIDevelopmentPageClient() {
  return (
    <ConsultancyLoadedShell label="CUSTOM BUILD">
      ...
      <Metrics />
      <Method />
      <CardsSection eyebrow="Six capabilities" title="WHAT WE BUILD." items={BUILDS} />
      <CardsSection eyebrow="Built for these teams" title="WHO THIS IS FOR." items={PERSONAS} />
      <QuotesSection />
      <FAQSection />
      <CTAStrip
