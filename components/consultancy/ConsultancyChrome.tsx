...
export function ConsultancyChrome() {
  useEffect(() => {
    const dot = document.getElementById("c-dot-consultancy");
    const ring = document.getElementById("c-ring-consultancy");
    if (!dot || !ring) return;
    ...
    const onOver = (e: MouseEvent) => {
      ...
      if (t?.closest("a,button,[role=button],input,textarea,select,.hv")) {
    ...
    document.body.classList.remove("cc", "ch");
  ...
  return (
    <>
      <div id="c-ring-consultancy" aria-hidden />
      <div id="c-dot-consultancy" aria-hidden />
    </>
  );
}
